...
private:
	...
	void drawracketpole();
	void drawracketpoleright1();
	void drawracketpoleright2();
	void drawracketpoleright3();
	void drawracketpoleright4();
	void drawracketpoleleft1();
	void drawracketpoleleft2();
	void drawracketpoleleft3();
	void drawracketpoleleft4();
	void drawracketmidtop();
	void drawracketmidtop2();
	void drawracketgrid();
